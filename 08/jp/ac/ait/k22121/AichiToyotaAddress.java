...
public class AichiToyotaAddress implements IKadai07_5{
    ...
    @Override
    public Map<String, String> searchByCode(String postalCode){
        Map<String, String> code_map = new HashMap<>();

        for (String key: POSTALCODE_MAP.keySet()) {
            if (key.startsWith(postalCode)){
//                System.out.println("キー：" + key + " 値：" + POSTALCODE_MAP.get(key));
                code_map.put(key, POSTALCODE_MAP.get(key));
            }
        }
    ...
    @Override
    public Map<String, String> searchByAddress(String addressText){
        Map<String, String> add_map  = new HashMap<String, String>();

        for (String key: POSTALCODE_MAP.keySet()) {
            if (POSTALCODE_MAP.get(key).contains(addressText)){
//                System.out.println("キー：" + key + " 値：" + POSTALCODE_MAP.get(key));
                add_map.put(key, POSTALCODE_MAP.get(key));
            }
        }
    ...
    public static void main(String[] args) {
        AichiToyotaAddress app = new AichiToyotaAddress();

        System.out.println(app.searchByCode("44428"));
        System.out.println(app.searchByCode("47003"));
        System.out.println(app.searchByCode("47100"));

        System.out.println(app.searchByAddress("郷町"));
        System.out.println(app.searchByAddress("小原"));
        System.out.println(app.searchByAddress("若林"));
    }
}
