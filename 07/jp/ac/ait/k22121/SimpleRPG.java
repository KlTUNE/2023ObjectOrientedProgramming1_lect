...
public class SimpleRPG {
    ...
    Hero createHero() {
        ...
        final String[] JOB_NAMES = {"セイバー", "アーチャー", "ランサー"};
        ...
        int job_num = random.nextInt(3);
        String job_name = JOB_NAMES[job_num];

        Hero[] jobs = {
                new Saber(name, hp, atk, def, agi),
                new Archer(name, hp, atk, def, agi),
                new Lancer(name, hp, atk, def, agi),
        };

        System.out.println("職業:" + job_name);
...
//        System.out.println(job.toString());
    ...
    public static void main(String[] args) {
        ...
        Weapon weapon = new Weapon("ヒノキの棒", 4);
